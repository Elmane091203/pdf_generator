  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <Select
          value={templateType}
          onValueChange={(value: "bep" | "bp" | "bt") => setTemplateType(value)}
        >
          <SelectTrigger id="template-select">
            <SelectValue placeholder="Sélectionner un template" />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="bep">
      ...
      <div className="space-y-2">
        ...
        <RadioGroup
          value={downloadMode}
          onValueChange={(value: "zip" | "individual" | "signature") =>
      ...
      {downloadMode === "signature" && (
        <div className="space-y-4 p-4 border rounded-lg bg-blue-50">
          ...
          <div>
            <Label>
              Position de la signature (coordonnées normalisées 0-1)
            </Label>
        ...
        <div className="space-y-4">
          <div className="p-4 border rounded-lg bg-green-50">
            ...
            <p className="text-sm text-green-700">
              Le template DocuSeal a été créé. Vous pouvez maintenant signer le
              document.
            </p>
          ...
          <div>
            ...
            <DocuSealFormComponent src={result.signUrl} email={signerEmail} />
          </div>
        </div>
      )}

      <DocuSealFormComponent
        // src={`http://localhost:50852/d/xjPzQAzT4Xmy99`}
        src={`https://firndebi.mosikasign.com/s/uxhwSKnfQCBXsM`}
        // src={`https://docuseal.co/d/4ZHarL6mpstBDV`}
        email={signerEmail}
      />
    </div>
  );
